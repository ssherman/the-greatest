...
module Music
  class ArtistTest < ActiveSupport::TestCase
    ...
    test "should populate details with AI successfully" do
      ...
      Services::Ai::Tasks::Music::ArtistDescriptionTask.expects(:new).with(parent: @person).returns(mock_task)
    ...
    test "should handle AI task exceptions gracefully" do
      ...
      Services::Ai::Tasks::Music::ArtistDescriptionTask.expects(:new).with(parent: @person).raises(StandardError.new("Task creation failed"))
    ...
    test "should handle band type artists with AI" do
      ...
      Services::Ai::Tasks::Music::ArtistDescriptionTask.expects(:new).with(parent: @band).returns(mock_task)
      mock_task.expects(:call).returns(mock_result).with do
        # Simulate the process_and_persist behavior
        @band.update!(
          description: "English progressive rock band",
