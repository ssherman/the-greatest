  ...
  module Music
    module Songs
      class RankingConfigurationsControllerTest < ActionDispatch::IntegrationTest
        setup do
          @ranking_configuration = ranking_configurations(:music_songs_global)
          @secondary_configuration = ranking_configurations(:music_songs_secondary)
        ...
        test "should redirect index to root for unauthenticated users" do
          get admin_songs_ranking_configurations_path
        ...
        test "should get index with search query" do
          ...
          get admin_songs_ranking_configurations_path(q: "Global")
          assert_response :success
        end
        ...
        test "should handle empty search results without error" do
          ...
          assert_nothing_raised do
            get admin_songs_ranking_configurations_path(q: "nonexistentconfig")
          end
        ...
        test "should handle sorting by name" do
          sign_in_as(@admin_user, stub_auth: true)
          get admin_songs_ranking_configurations_path(sort: "name")
          assert_response :success
        end

        test "should handle sorting by id" do
          sign_in_as(@admin_user, stub_auth: true)
          get admin_songs_ranking_configurations_path(sort: "id")
          assert_response :success
        end

        test "should handle sorting by algorithm_version" do
          sign_in_as(@admin_user, stub_auth: true)
          get admin_songs_ranking_configurations_path(sort: "algorithm_version")
          assert_response :success
        end
        ...
        test "should reject invalid sort parameters and default to name" do
          ...
          assert_nothing_raised do
            get admin_songs_ranking_configurations_path(sort: "'; DROP TABLE ranking_configurations; --")
          end
          assert_response :success

          # Verify ranking_configurations table still exists by querying it
          assert ::Music::Songs::RankingConfiguration.count > 0
        end
        ...
        test "should only allow whitelisted sort columns" do
          ...
          ["id", "name", "algorithm_version", "published_at", "created_at"].each do |column|
            get admin_songs_ranking_configurations_path(sort: column)
            assert_response :success
          end
        ...
        test "should get show for admin" do
          sign_in_as(@admin_user, stub_auth: true)
          get admin_songs_ranking_configuration_path(@ranking_configuration)
          assert_response :success
        end
        ...
        test "should get new for admin" do
          sign_in_as(@admin_user, stub_auth: true)
          get new_admin_songs_ranking_configuration_path
          assert_response :success
        end
        ...
        test "should create ranking configuration for admin with valid params" do
          ...
          assert_difference("::Music::Songs::RankingConfiguration.count", 1) do
            post admin_songs_ranking_configurations_path, params: {
          ...
          assert_redirected_to admin_songs_ranking_configuration_path(::Music::Songs::RankingConfiguration.last)
        ...
        test "should update ranking configuration for admin" do
          ...
          patch admin_songs_ranking_configuration_path(@ranking_configuration), params: {
            ranking_configuration: {
              name: "Updated Name",
          ...
          assert_redirected_to admin_songs_ranking_configuration_path(@ranking_configuration)
        ...
        test "should destroy ranking configuration for admin" do
          ...
          assert_difference("::Music::Songs::RankingConfiguration.count", -1) do
            delete admin_songs_ranking_configuration_path(@secondary_configuration)
          end

          assert_redirected_to admin_songs_ranking_configurations_path
        ...
        test "should execute action for admin" do
          ...
          ::Music::Songs::RankingConfiguration.any_instance.expects(:calculate_rankings_async)

          post execute_action_admin_songs_ranking_configuration_path(
            @ranking_configuration,
        ...
        test "should execute index action for admin" do
          ...
          post index_action_admin_songs_ranking_configurations_path(
