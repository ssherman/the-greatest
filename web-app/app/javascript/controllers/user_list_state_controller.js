...
export default class extends Controller {
  ...
  // querySelectorAll covers both the mobile and desktop menu copies. Books
  // groups its personal links under one hook; Music and Games retain their
  // existing My Lists hook.
