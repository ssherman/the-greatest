...
module Movies
  class Category < ::Category
    ...
    has_many :movies, through: :category_items, source: :item, source_type: "Movies::Movie"

    # Movies-specific scopes
    scope :by_movie_ids, ->(movie_ids) { joins(:category_items).where(category_items: {item_type: "Movies::Movie", item_id: movie_ids}) }
  end
end
