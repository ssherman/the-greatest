...
class Rankings::PenaltyTableComponent < ViewComponent::Base
  ...
  INTROS = {
    ...
    "list_time_scope" => "A list of the best books of the 2010s cannot tell you what the greatest book ever written is; it was never asking. The narrower a list's window, the less its verdict generalises, so a single-year award is reduced far more than a list spanning a century.",
    "list_subject_scope" => "The same logic applies to subject. A list restricted to one country, one language, one genre or one gender is answering a narrower question than \"what is the greatest\". We do not discard these — they are often the most careful lists we have, and they are where work from outside the usual centres gets its due — but first place among fifty is a smaller achievement than first place among all of them.",
    "list_integrity" => "Some lists are not really rankings. They are inventories of five hundred titles, or sequels collecting what an earlier list left out, or affiliate pages built by someone who sells the books. Others are simply undocumented, and we cannot establish who made them or how. These adjustments concern how a list came to exist rather than what it covers."
  }.freeze
