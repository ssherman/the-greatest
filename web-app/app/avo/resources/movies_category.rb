class Avo::Resources::MoviesCategory < Avo::BaseResource
  self.title = :name
  self.description = "Movies-specific categories for films and cinema"
  self.model_class = ::Movies::Category
  ...
  def fields
    ...
    field :parent, as: :belongs_to, class_name: "Movies::Category"

    # Movies-specific associations
    field :movies, as: :has_many, through: :category_items

    # Child categories
    field :child_categories, as: :has_many, class_name: "Movies::Category"
