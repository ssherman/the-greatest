class Admin::RankingConfigurationsController < Admin::BaseController
  ...
  def new
    ...
    authorize @ranking_configuration, policy_class: policy_class
  end
  ...
  def domain_name
    raise NotImplementedError, "Subclass must implement domain_name"
  end
end
