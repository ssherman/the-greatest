class Admin::ListsBaseController < Admin::BaseController
  ...
  rescue List::AutoGeneratedListError => e
    # The Delete button is hidden for a generated list; a stale tab or a
    # bookmarked URL still reaches here, and must not 500.
